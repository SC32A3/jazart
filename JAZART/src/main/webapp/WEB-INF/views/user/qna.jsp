						...
						<ul class="collapsible qt-chart-tracklist qt-spacer-m"
							...
							<li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
								...
								<div class="collapsible-body qt-paper">
									<p>기존의 허접하고 겁나 어려운 작곡 프로그램에 화가나셨나요? 내가 만든곡을 겁나 자랑하고 싶은데 어디서
										자랑해야 될지 모르겠다고요? 21세기 울트라 최첨단 신기술 멀티 작곡 프로그램 Jazart가 여러분의 꽉~막힌
										고민은 아주 시~원하게 뚫어 드립니다. 초급자들은 몇번의 클릭만으로 빌보드 차트에 오를 만한 곡을 아주 손쉽게,
										고급자들은 자신의 감성을 살린 곡을 소름끼치도록 만들 수 있게 Jazart로 여러분의 숨겨진 잠재력을 폭발
										시켜보세요.</p>
								</div>
							</li>
							<!-- CHART TRACK END ========================= -->
							...
							<li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
								...
								<div class="collapsible-body qt-paper">
									<p>초급은 그동안의 어려웠던 작곡 스타일을 과감히 버리고 전문가들이 만든 멜로디를 추천받아
										장르?분위기?에 따라 겁나 허벌나게 완벽한 음악을 만들 수 있는 전설의 시스템 입니다. 고급은 어려분의
										실력발휘를 하여서 모짜르트를 뛰어 넘는 여러분의 실력을 섬세하게 발휘할 수 있도록 저희가 다~준비 해놓았습니다.
										이제 여러분이 해야 할 일은 어려분의 즐거운 작곡 여정을 시작하는 일입니다.♥</p>
								</div>
							</li>
							<!-- CHART TRACK END ========================= -->
							<!-- CHART TRACK ========================= -->
							...
							<li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
								...
								<div class="collapsible-body qt-paper">
									<p>저희 제품을 사용하시다 궁금한 점이나 불편함이 있으시다면 전화, 온라인, 문자, 채팅, 팩스를
										이용하여 문의하실 수 있습니다. 아래의 방법 중, 편한 방법을 활용하여 문의 주시면 빠른 시일 내에 답변 또는
										연락 드리겠습니다. - 전화상담: 080-022-7007 - 온라인상담: 제품관련 문의하러 가기 - 채팅상담 :
										채팅상담 바로 가기 - 팩스상담: 02-528-2678</p>
								</div>
							</li>
							<!-- CHART TRACK END ========================= -->
							<!-- CHART TRACK ========================= -->
							<li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
								...
								<div class="collapsible-body qt-paper">
									<p>안드로이드 버전이 있으므로 지금 구글플레이에서 다운받아 사용해보세요.</p>
								</div>
							</li>
							<!-- CHART TRACK END ========================= -->
							<!-- CHART TRACK ========================= -->
