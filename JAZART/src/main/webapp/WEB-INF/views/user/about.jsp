		...
		<div id="maincontent" class="qt-main">
			...
			<div class="qt-pageheader qt-negative">
				...
				<div class="qt-header-yg" data-bgimage="images/table.jpg">
					<img src="images/table.jpg" alt="Featured image" width="690"
						height="302">
				</div>
			</div>
			<!-- HEADER CONTACTS END ========================= -->
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 text-center">
							...
							<p class="text-justify"
								style="display: inline-block; width: 300px;">I'm sure that
								working with foreign person in other country will help in
								improving my somewhat narrow vision.</p>
						</div>
						<div class="col-md-6 text-center">
							<img class="img-responsive"
								style="border-radius: 50%; width: 250px; height: 250px;"
							...
							<br />
							<p class="text-justify"
								style="display: inline-block; width: 300px;">I think that
								while going through different circumstances, I can make many
					...
					<div class="row">
						<div class="col-md-6 text-center">
							...
							<br />
							<p class="text-justify"
								style="display: inline-block; width: 300px;">The fact that
								I'm applying and working in your company means I'm challenging
								now and I'll challenge also.</p>
						</div>
						<div class="col-md-6 text-center">
							<img class="img-responsive"
								style="border-radius: 50%; width: 250px; height: 250px;"
							...
							<br />
							<p class="text-justify"
								style="display: inline-block; width: 300px;">I don't want to
								make anyone I know disappointed because of me. That's why I
								always do my best when it comes to doing something with other
								people.</p>
						</div>
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4 text-justify">
							...
							<p>We are making the best of design that nobody can't make
								like this.</p>
						</div>
						<div class="col-md-2 text-center">
							<span class="services-circle text-center"><i
						...
						<div class="col-md-4 text-justify">
							...
							<p>We can making everything in your mind. Tell us whatever
								you want. We are the best team all of the world.</p>
						</div>
					</div>
					<br />
					<div class="row">
						...
						<div class="col-md-4 text-justify">
							...
							<p>We are ready to change our program for users convenience.
								If you have a good idea tell me right now!!.</p>
						</div>
						<div class="col-md-2 text-center">
							<span class="services-circle text-center"><i
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<ul class="list-unstyled text-center">
								...
								<li class="filter btn btn-danger" data-filter=".graphic">DRUM</li>
								<li class="filter btn btn-danger" data-filter=".print">GUITAR</li>
								<li class="filter btn btn-danger" data-filter=".webdesign">PIANO
								</li>
							</ul>
						</div>
						<div class="mix graphic col-md-4 col-sm-6 col-xs-12">
							<a href="images/drum1.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/drum1.jpg" />
							</a>
						</div>
						<div class="mix print col-md-4 col-sm-6 col-xs-12">
							<a href="images/piano1.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/piano1.jpg" />
							</a>
						</div>
						<div class="mix webdesign col-md-4 col-sm-6 col-xs-12">
							<a href="images/guitar1.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/guitar1.jpg" />
							</a>
						</div>
						<div class="mix webdesign col-md-4 col-sm-6 col-xs-12">
							<a href="images/guitar2.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/guitar2.jpg" />
							</a>
						</div>
						<div class="mix print col-md-4 col-sm-6 col-xs-12">
							<a href="images/piano2.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/piano2.jpg" />
							</a>
						</div>
						<div class="mix print col-md-4 col-sm-6 col-xs-12">
							<a href="images/piano3.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/piano3.jpg" />
							</a>
						</div>
						<div class="mix graphic col-md-4 col-sm-6 col-xs-12">
							<a href="images/drum2.jpeg" class="img-wrapper"> <img
								class="img-responsive" src="images/drum2.jpeg" />
							</a>
						</div>
						<div class="mix webdesign col-md-4 col-sm-6 col-xs-12">
							<a href="images/guitar3.png" class="img-wrapper"> <img
								class="img-responsive" src="images/guitar3.png" />
							</a>
						</div>

						<div class="mix graphic col-md-4 col-sm-6 col-xs-12">
							<a href="images/drum3.jpg" class="img-wrapper"> <img
								class="img-responsive" src="images/drum3.jpg" />
							</a>
						</div>
					</div>
				</div>
			...
			<div class="qt-footer qt-footerwidgets">
				<div class="qt-section qt-footer-widgets qt-content-primary-light">
					...
					<div class="qt-header-bg" data-bgimage="images/back.jpg">
						<img src="images/back.jpg" width="690" height="302">
					</div>
				</div>
