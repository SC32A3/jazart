        ...
        <div class="qt-parentcontainer">
            ...
            <nav class="qt-menubar nav-wrapper qt-content-primary ">
                ...
                <ul class="qt-desktopmenu hide-on-xl-and-down">
                    ...
                    <li class="right"><a href="resources/page-popup.html" class="qt-popupwindow" data-name="Music Player" data-width="320" data-height="500"><i class="icon dripicons-duplicate"></i> Popup</a></li>
            ...
            <ul class="qt-mobile-toolbar qt-content-primary-dark qt-content-aside hide-on-large-only">
                ...
                <li><a href="resources/page-popup.html" class="qt-popupwindow" data-name="Music Player" data-width="320" data-height="500"><i class="icon dripicons-duplicate"></i></a></li>
            ...
            <div id="maincontent" class="qt-main">
                                ...
                                <div class="qt-item">
                                    ...
                                    <div class="qt-part-archive-item qt-part-archive-item-show qt-negative">
                                        <div class="qt-item-header">
                                            ...
                                            <div class="qt-header-bottom">
                                                <a href="resources/#read" class="qt-btn qt-btn-primary qt-readmore"><i class="dripicons-headset"></i></a>
                                            </div>
                                            <div class="qt-header-bg" data-bgimage="resources/imagestemplate/medium-690-302.jpg">
                                                <img src="resources/imagestemplate/medium-690-302.jpg" alt="Featured image" width="690" height="302">
                                            </div>
                ...
                <!-- ======================= SCHEDULE  SECTION ======================= -->
                <div class="qt-container qt-spacer-l">
                    <h3 class="qt-caption-med"><span>Realtime Chart</span></h3>
                    <hr class="qt-spacer-s">
                    <!-- SCHEDULE ================================================== -->
                    <div class="qt-show-schedule">
                        ...
                        <ul class="tabs">
                            ...
                            <li class="tab"><a href="#daywednesday">Daily</a></li>
                            <li class="tab"><a href="#daythursday">Weekly</a></li>
                            ...
                            <div class="qt-slickslider qt-slickslider-multiple qt-text-shadow " data-slidestoshow="6" data-slidestoshowipad="3" data-variablewidth="false" data-arrows="true" data-dots="false" data-infinite="true" data-centermode="false" data-pauseonhover="true" data-autoplay="true" data-arrowsmobile="false" data-centermodemobile="true" data-dotsmobile="false" data-slidestoshowmobile="1" data-variablewidthmobile="true" data-infinitemobile="false">
                                ...
                                <div class="qt-item">
                                    <a href="#" target="_blank" rel="nofollow" class="qt-sponsor">
                                        <img src="resources/imagestemplate/sponsor.png" width="235" height="132" alt="sponsor" class="qt-image-responsive">
                                    </a>
                                </div>
                                <!-- SLIDESHOW ITEM -->
                                <div class="qt-item">
