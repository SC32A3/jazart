									...
									<div class="qt-valign flow-text">
										<div class="qt-booking-form" data-100p-top="opacity:0;"
											...
											<ul class="tabs">
												<li class="tab col s4">
													<h5>
														<a href="#form" class="active">Send a message</a>
													</h5>
												</li>
												<li class="tab col s4">
													<h5>
											...
											<div id="form" class="row">
												<form class="col s12" method="post"
													action="email_sender.php">
													<input type="hidden" name="antispam" value="x123">
													<h3 class="left-align qt-vertical-padding-m">Send a
														message using the form below</h3>
													<div class="row">
														<div class="input-field col s6">
															<input name="first_name" id="first_name" type="text"
																class="validate"> <label>First Name</label>
														</div>
														<div class="input-field col s6">
															<input name="last_name" id="last_name" type="text"
																class="validate"> <label>Last Name</label>
														</div>
													</div>
													<div class="row">
														<div class="input-field col s12">
															<input name="email" id="formemail" type="email"
																class="validate"> <label>Email</label>
														</div>
													</div>
													<div class="row">
														<div class="input-field col s12">
															<textarea name="message" id="message"
																class="materialize-textarea" maxlength="300"></textarea>
													...
													<div class="row">
														<div class="input-field col s12">
															<input name="privacy" type="checkbox" id="privacy"
																value="1" /> <label>I red and accept the <a
																href="#" target="_blank">privacy terms</a>.
															</label>
														</div>
													</div>
											...
											<div id="contacts" class="row qt-contacts">
												<div class="col s12">
													<h3 class="left-align qt-vertical-padding-m">Our
														contacts</h3>
													<p>
														<i class="qt-bigicon dripicons-phone"></i><span>+44
															443 53 2324</span>
													</p>
													<p>
														<i class="qt-bigicon dripicons-phone"></i><span>info@bookmenow.com</span>
													</p>
													<p>
														<i class="qt-bigicon dripicons-phone"></i><span>Road
															Avenue, California</span>
													</p>
												</div>
											</div>
											<div id="map" class="qt-map">
												<iframe
													src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2823.9899192531298!2d-123.04142404893491!3d44.94387287592946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54bfff0c89be210f%3A0x79aa007f04406672!2s295+Center+St+NE%2C+Salem%2C+OR+97301%2C+USA!5e0!3m2!1sen!2ses!4v1478257655617"
