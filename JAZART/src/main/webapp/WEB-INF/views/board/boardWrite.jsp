                                ...
                                <div class="qt-valign-wrapper">
                                    <div class="qt-valign flow-text">
                                        <div class="qt-booking-form" data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-30p-top="opacity:1;">
                                            <ul class="tabs">
                                                <li class="tab col s4">
                                                    <h5><a href="#form" class="active">Write</a></h5></li>
                                            </ul>
                                            <div id="form" class="row">
                                                <form class="col s12" method="post" action="boardWrite" enctype="multipart/form-data"> <!-- email_sender.php -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s8">
                                                            <input name="board_title" id="board_title" type="text" class="validate">
                                                            <label>Title</label>
                                                        </div>
                                                  
                                                        <div class="input-field col s12 ">
                                                           <p class="comment-form-comment">
														    <textarea style="height: 25rem" id="board_content" placeholder="Content *" name="board_content" cols="45" aria-required="true"></textarea>
														   </p>
                                                        </div>
                                                    </div>
