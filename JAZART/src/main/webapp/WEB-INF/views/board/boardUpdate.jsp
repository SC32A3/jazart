...
<script type="text/javascript">
	$(function() {
		var genre = '${board.board_tag}';
		$("#select_id").val(genre).prop("selected", true);
	});
</script>
</head>
<body>
								...
								<div class="qt-valign flow-text">
									<div class="qt-booking-form" data-100p-top="opacity:0;"
										...
										<ul class="tabs">
											<li class="tab col s4">
												<h5>
													<a href="#form" class="active">update</a>
												</h5>
											</li>
										</ul>
										<div id="form" class="row">
											<form class="col s12" method="post" action="boardUpdate"
												...
												<div class="row">
													...
													<div class="input-field col s6 l2">
														<select name="board_tag" id="select_id"
													...
													<div class="input-field col s8">
														<input name="board_title" value="${board.board_title}"
															id="board_title" type="text" class="validate"> <label>Title</label>
													</div>
													...
													<div class="input-field col s12 ">
														<p class="comment-form-comment">
															<textarea
																...
																id="board_content" name="board_content" cols="45"
																aria-required="true">${board.board_content}</textarea>
														</p>
													</div>
												</div>
