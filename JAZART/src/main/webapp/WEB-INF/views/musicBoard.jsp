    ...
    <!-- QT HEADER END ================================ -->
                                ...
                                <div class="col s12 m3 l12">
                                    <div class="qt-widget">
                                        ...
                                        <form method="post" action="search" class="qt-inline-form">
                                            <div class="row qt-nopadding">
                                                <div class="col s12 m8 l9">
                                                    <input placeholder="Music Search" value="" type="text" class="validate qt-input-s">
                                                </div>
                                                <div class="col s12 m4 l3">
                                                    <input type="button" value="Search" class="qt-btn qt-btn-secondary qt-btn-s qt-fullwidth">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
		...
		<div class="qt-part-archive-item qt-item-member">
			<div class="qt-item-header">
				...
				<div class="qt-header-mid qt-vc">
					<div class="qt-vi">
						<h4 class="qt-ellipsis qt-title">
							<a href="single-member.php" class="qt-text-shadow">Tom Rogers</a>
						</h4>
					</div>
				</div>
				...
				<div class="qt-header-bg" data-bgimage="imagestemplate/medium-690-302.jpg">
					<img src="imagestemplate/medium-690-302.jpg" alt="Featured image" width="690" height="690">
				</div>
			</div>
		...
		<!-- PAGINATION END ========================= -->
					...
					<div class="qt-container">
						...
						<div class="qt-widgets qt-widgets-footer qt-negative qt-spacer-m row">
							<div class="col s12 m3 l3">
								<div class="qt-widget">
			<h5 class="qt-caption-small"><span>Stay Connected</span></h5>
			...
			<div class="qt-widget-about">
				<p>
					We are a young and dynamic radio station which wants to bring happyness in your life.<br>
		...
		<div id="channelslist" class="side-nav qt-content-primary qt-right-sidebar">
			...
			<!-- PLAYER ========================= -->
		<div  id="qtplayercontainer" data-playervolume="true" data-accentcolor="#dd0e34" data-accentcolordark="#ff0442" data-textcolor="#ffffff" data-soundmanagerurl="./components/soundmanager/swf/" 
		...
		<!-- PLAYER SIDEBAR END ========================= -->        <!-- QT BODY END ================================ -->
