                                    ...
                                    <div class="qt-valign flow-text">
                                        <div class="qt-booking-form" data-100p-top="opacity:0;" data-80p-top="opacity:0;" data-30p-top="opacity:1;">
                                            ...
                                            <div id="form" class="row">
                                                <form class="col s12" method="post" action="boardUpdate" enctype="multipart/form-data"> <!-- email_sender.php -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s8">
                                                            <input name="board_title" value="${board.board_title}" id="board_title" type="text" class="validate">
                                                            <label>Title</label>
                                                        </div>
                                                  		<div>
                                                  		<tr><td>작성자</td><td>${board.board_nickname}</td></tr>
														<tr><td>작성일</td><td>${board.board_inputdate}</td></tr>
                                                  		</div>
