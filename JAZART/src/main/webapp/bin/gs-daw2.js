...
function gswaSample(t, e) {
	alert("gswaSample t: "+t); //JSON 안먹힘
	alert("gswaSample e: "+e); //JSON 안먹힘
...
window.AudioContext || (document.body.innerHTML = "<div id='nowebaudio'>Sorry, <i><b>GridSound</b></i> is not compatible with this browser ¯\\_(ツ)_/¯<br/>Maybe you should use&nbsp;: <i class='icon chrome'></i> <i>Chrome</i> or <i class='icon firefox'></i> <i>Firefox</i> or <i class='icon safari'></i> <i>Safari</i>.</div>"), ! function() {
        function t(t) {
        ...
        createSample: function(t) {
            ...
            alert('createSample: '+e);
            return t.samples.push(e), e
        },
        createBuffer: function() { //드래그할때 버퍼생성 처음!
        	alert('createBuffer: '+this.toString());
            return new gswaBuffer(this)
        },
        createFilters: function() { //초기값
            return new gswaFilters(this)
        },
        createComposition: function() { //초기값
    ...
    function() {
        ...
        e.bpm = t({     //초기화면값
            ...
            useData: !0
        }), e.itemBuffer = t({  //드래그시 뜨는 이벤트
            compiler: [7, ">= 4.0.0"],
            main: function(t, e, i, n, s) {
                var o, a;
                var test = '<a class="item buffer" draggable="true">\r\n' + (null != (o = t.invokePartial(n.gsuiWaveform, e, {
                    name: "gsuiWaveform",
                    data: s,
                    indent: "\t",
                    helpers: i,
    ...
    function() {
        ...
        alert('gs.file.joinFile t: '+t);
        alert('gs.file.joinFile e: '+e);
        alert('gs.file.joinFile i: '+i);
        ...
        alert('gs.file.load e: '+e);
        alert('gs.file.load i: '+i);
    ...
    function() {
    ...
    }), ui.initElement("exportToWaveFile", function(t) { //저장기능
        return {
            click: function(t) {
        ...
        return {
            ...
            insertInto: function(e) { //리스트에서 재생 보여주는 것
            	alert("insertinto: "+e);
                t.style.transitionDuration = t.style.left = 0, e.elRoot.appendChild(t)
            },
            startMoving: function(e) { //리스트에서 재생 보여주는 것
            	alert("startmoving: "+e);
    ...
    function() {
        ...
        waFwk.on.addSource = function(e) {
            ...
            alert("addSource i: "+JSON.stringify(i));
            alert('addSource n: '+JSON.stringify(n));
    ...
    function() {
        function t() {
            ...
            this.elColLinesTrack.uitrack = this, this.wfilters = gs.wctx.createFilters(),ui.dom.tracksNames.appendChild(this.elColNamesTrack), ui.dom.tracksLines.appendChild(this.elColLinesTrack), this.gsuiToggle = new gsuiToggle(this.elColNamesTrack.querySelector(".gsuiToggle"), {
                onchange: function(e) {
