...
public class PageNavigator {
	...
	private int endRecord; // 전체 레코드 중 현재 페이지 마지막 글의 위치
	...
	public PageNavigator(int countPerPage, int pagePerGroup, int currentPage, int totalRecordsCount) {
		...
		startRecord = (currentPage - 1) * countPerPage + 1;
		setEndRecord(startRecord + countPerPage - 1);
	}
	...
	public String toString() {
		return "PageNavigator [countPerPage=" + countPerPage + ", pagePerGroup=" + pagePerGroup + ", totalRecordsCount="
				+ totalRecordsCount + ", totalPageCount=" + totalPageCount + ", startRecord=" + startRecord
				+ ", endRecord=" + endRecord + ", currentPage=" + currentPage + ", currentGroup=" + currentGroup
